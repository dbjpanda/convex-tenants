...
/**
 * Synchronous cascade delete. Removes all child rows (teams, teamMembers,
 * invitations, members) then the org doc itself in a single mutation.
 *
 * Known scale ceiling: hits Convex transaction limits at ~100 members / ~30 teams.
 * For larger orgs, implement an async delete wrapper via a scheduled action in
 * the consumer app. See docs/known-limitations.md for guidance.
 */
