...
- **Organizations** — Create, update, delete; unique slugs; optional status (`active` / `suspended` / `archived`); transfer ownership
- **Members** — Add, remove, update roles; roles are flexible strings you define in authz
- **Teams** — Create teams with optional slug and metadata; manage membership
- **Invitations** — Invite by email with optional message and team; customizable expiration
