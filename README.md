...
- **Teams** — Create teams with optional slug and metadata; manage membership; [paginated lists](docs/api-reference.md) for teams and for team members
- **Invitations** — Flexible identifier-based invitations (email, phone, username, etc.); customizable validation callbacks for create and accept; optional message and team assignment; customizable expiration; [paginated list](docs/api-reference.md)
...
| [Invitation System](docs/invitation-system.md) | Flexible identifier validation and examples |
| [Migration Guide](MIGRATION_GUIDE.md) | Breaking changes and upgrade instructions |
